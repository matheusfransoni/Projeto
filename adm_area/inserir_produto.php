...
include($_SERVER['DOCUMENT_ROOT']."/adm_area/Includes/db.php");
...
<body bgcolor="skyblue">
	...
	<form action="inserir_produto.php" method="post" enctype="multipart/form-data">
		...
		<table align="center" width="600" border="2" bgcolor="orange">
			...
			<tr>
				<td align="right"><b>Descricao do Produto:</b></td>
			...
			<tr align="center">
				<td colspan="2"><input type ="submit" name="insert_post" value="Enviar" /></td>
			</tr>
...
<?php
	...
	if(isset($_POST['insert_post'])){
		...
		if($inserir_pro){
		 ...
		 header('Localização: /adm_area/index.php');
